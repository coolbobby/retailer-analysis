...
with tab_generate:
    ...
    with c1:
        ...
        st.download_button(
            ...
            data=_read_file_bytes(DEFAULT_POS),
            file_name=os.path.basename(DEFAULT_POS),
            mime="text/csv",
            key="dl_default_pos",
    ...
    with c2:
        ...
        st.download_button(
            "⬇ Download default file",
            data=_read_file_bytes(DEFAULT_BCD),
            file_name=os.path.basename(DEFAULT_BCD),
            mime="text/csv",
            key="dl_default_bcd",
            use_container_width=True,
        )
    with c3:
        ...
        st.download_button(
            "⬇ Download default file",
            data=_read_file_bytes(DEFAULT_DBN),
            file_name=os.path.basename(DEFAULT_DBN),
